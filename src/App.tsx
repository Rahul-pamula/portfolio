      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin relative pb-32 w-full">
        <div className="mx-auto w-full max-w-[1600px] p-4 md:p-6 lg:p-8">
          <div className="grid grid-cols-1 xl:grid-cols-[280px_minmax(0,_1fr)_280px] 2xl:grid-cols-[300px_minmax(0,_1fr)_300px] gap-6 xl:gap-8 items-start">
            ...
            {/* Main Floating Panel - transparent shell, CSS vars control theme */}
            <main className="flex flex-col gap-12 bg-background/30 rounded-3xl border border-border/30 shadow-2xl p-6 lg:p-10">
            ...
            <div className="hidden xl:block xl:sticky xl:top-8">
              <div id="activity-desktop" className="bg-background/30 rounded-3xl border border-border/30 shadow-2xl p-6">
                <LiveActivityFeed />
              </div>
            </div>
